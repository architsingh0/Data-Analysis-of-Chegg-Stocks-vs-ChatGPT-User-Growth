...
# Plot the data
ggplot(df_q6_count, aes(x = Q6.Domains, y = Count)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Industries", y = "Count", title = "Q6: Impact Of AI Across Different Industries")
```
...
ggplot(students_survey_ai, aes(x = Q7.Utility_grade)) +
  ...
  labs(x = "Rating (1-10)", y = "Count", title = "Q7: How Useful Do You Think AI Would Be In The Educational Process")
...
ggplot(one_mil_users, aes(x = reorder(Service, Days_to_reach_1M_users), y = Days_to_reach_1M_users)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  geom_text(aes(label = Days_to_reach_1M_users), hjust=-0.01) +
  labs(x = "Service", y = "Days to reach 1M users") +
  coord_flip() +
